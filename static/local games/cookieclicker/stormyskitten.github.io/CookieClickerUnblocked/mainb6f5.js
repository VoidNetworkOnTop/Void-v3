...
Game.Launch=function()
{
	...
	'<div class="listing">'+loc("Cookie Clicker is a javascript game by %1 and %2.",['<a href="https://discord.gg/M5vcveZbGx" target="_blank">Void Network</a>','<a href="//dashnet.org" target="_blank">Opti</a>'])+'</div>'+
...
Game.showBackupWarning=function()
{
	Game.Notify(loc("Void Network"),loc("Hello Void Network user! Make sure to join the discord for more unblocked links! <a href=\"https://discord.gg/M5vcveZbGx\" target=\"_blank\" style=\"color:#7289da;text-decoration:underline;\">https://discord.gg/M5vcveZbGx</a>"),[25,7]);
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarOrteil'),'<div style="padding:8px;width:250px;text-align:center;">The best gaming website</div>'+tinyIcon([17,5],'display:block;margin:-12px auto;'),'this');
		...
		Game.promptGiftSend=function()
		{
			...
			Game.Prompt('<id GiftSend><h3>'+loc("Send a gift")+'</h3><div id="giftPromptSelector" style="overflow-x:hidden;overflow-y:scroll;position:absolute;left:0px;top:0px;right:0px;bottom:0px;z-index:10000;display:none;background:rgba(0,0,0,0.75);"></div><div class="block" style="font-size:11px;">'+tinyIcon([34,6])+'<div class="line"></div>'+
				...
				'<div style="opacity:0.7;">'+loc("Clicking \"Wrap\" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.",loc("Wrap"))+'</div>'+
			'</div>',[[loc("Cancel"),0,'float:right']],function(){
				if (!l('giftPromptContent'))
				{
					l('giftPromptContainer').innerHTML='<div id="giftPromptContent">'+
						'<div><div style="display:inline-block;vertical-align:middle;width:55%;margin-right:8px;">'+loc("You may put between 1 and 1000 cookies in the gift box.",[1,1000])+'</div><div style="display:inline-block;vertical-align:middle;width:38%;">'+'<div class="hasTinyCookie" style="display:inline-block;font-weight:bold;">'+loc("Cookies")+'</div><input type="text" style="text-align:center;width:100%;font-weight:bold;" id="giftAmount" value="'+(1+Math.floor(Math.random()*999))+'"/></div></div>'+
						'<div class="line"></div>'+
							'<div>'+loc("You can leave a note. Don't be rude!<br>Maximum 4 lines and 100 characters.",[4,100])+'</div>'+
